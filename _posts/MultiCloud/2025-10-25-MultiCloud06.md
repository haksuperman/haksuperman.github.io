---
title: "[Multi Cloud] AWS-OCI VPN Turnel 이중화 (BGP)_6.AWS-OCI VPN2 구성(AWS)"       # 글 제목
...
-   OCI 측의 VPN Turnel IP를 Customer Gateway로 생성해야 하지만, 아직 OCI 측 Turnel IP를 모르기 때문에 임시 Customer Gateway를 생성 (2.2.2.2)
...
![image](https://blog.kakaocdn.net/dna/RHhup/dJMb9N9Fd8D/AAAAAAAAAAAAAAAAAAAAAMkkq_En0-6iBbC2P9tc9rbZ20LcyAWAvTl2SlCQprGL/img.png?credential=yqXZFxpELC7KVnFOS48ylbz2pIh7yKj8&expires=1767193199&allow_ip=&allow_referer=&signature=UTaT13RceexlK6qD7MzUpSjVjeY%3D)

2. Create customer gateway
- Name tag : \<적절한 이름 입력>
- BGP ASN : 31898 (OCI 측 ASN은 31898 사용)
- IP address : \<적절한 임시 IP 입력>
![image](https://blog.kakaocdn.net/dna/RjYwV/dJMb9cuLhMY/AAAAAAAAAAAAAAAAAAAAAPjrJPqiXLmqfkJv8MxzOKSZcNnTLTTUDCOSHiKvQ2wM/img.png?credential=yqXZFxpELC7KVnFOS48ylbz2pIh7yKj8&expires=1767193199&allow_ip=&allow_referer=&signature=ZFch2483WC3hsxSV8p6cRXrKvcQ%3D)
...
3. 생성 확인
![image](https://blog.kakaocdn.net/dna/bcwr93/dJMb8WrVCJN/AAAAAAAAAAAAAAAAAAAAAPO0zO2FID2ozJKcL2_r4rZovu9PJTcWLxzDdZN-Ym_0/img.png?credential=yqXZFxpELC7KVnFOS48ylbz2pIh7yKj8&expires=1767193199&allow_ip=&allow_referer=&signature=vD8cLdtx9ir3jsfeDUz3qpMbSTw%3D)
...
![image](https://blog.kakaocdn.net/dna/devw5H/dJMb8WrVCJX/AAAAAAAAAAAAAAAAAAAAAGhzo_JwNl_9R1yYimdb3DjsDZSS1dwUk6fS37X-wFNP/img.png?credential=yqXZFxpELC7KVnFOS48ylbz2pIh7yKj8&expires=1767193199&allow_ip=&allow_referer=&signature=F%2BSFXFBLsQQ2800R%2FfEyrGl6DAg%3D)
...
![image](https://blog.kakaocdn.net/dna/dJm4hE/dJMb9P7tw5m/AAAAAAAAAAAAAAAAAAAAAM_twpxJN9PodTHmTwYVFHuyeyJ0Ndq6a5HP2Evu6o-A/img.png?credential=yqXZFxpELC7KVnFOS48ylbz2pIh7yKj8&expires=1767193199&allow_ip=&allow_referer=&signature=pN7XPXeG%2B%2BN3SO1Oamrdks2JzLc%3D)
...
- Inside IPv4 CIDR for turnel 1 : \<OCI 불가 CIDR 제외 하여 입력>
        ...
        {: .prompt-info }
- Advanced options for turnel 1 : Phase 1, 2에서 사용할 알고리즘 선택 (여기서는 기본 값으로 이용)
![image](https://blog.kakaocdn.net/dna/TdBIb/dJMb8WrVCKL/AAAAAAAAAAAAAAAAAAAAAGepxwVF6THYLdBqh12xWNOORIfI_KCgcccisN2uCUSi/img.png?credential=yqXZFxpELC7KVnFOS48ylbz2pIh7yKj8&expires=1767193199&allow_ip=&allow_referer=&signature=g1o%2FWmG1cBtEtU19h246a%2FGyIXc%3D)

4. 생성 확인
![image](https://blog.kakaocdn.net/dna/cu86pU/dJMb9fLM2Sv/AAAAAAAAAAAAAAAAAAAAAFGiKTjVEbBSa5OZfONU1LE0VHlGTh3tYuL9wf8dCrKe/img.png?credential=yqXZFxpELC7KVnFOS48ylbz2pIh7yKj8&expires=1767193199&allow_ip=&allow_referer=&signature=Q3na3ix1m76YhQ%2BCdmmLzFy2gOI%3D)

### 6.2.2. Configuration 파일 다운 및 확인

1. 우측 상단 → Download configuration 클릭
![image](https://blog.kakaocdn.net/dna/lZPXg/dJMb9jtS2Uw/AAAAAAAAAAAAAAAAAAAAANHL-SF1l2h5NDcAGi4TLQEAFOWFpndIL-6cJknH8rbw/img.png?credential=yqXZFxpELC7KVnFOS48ylbz2pIh7yKj8&expires=1767193199&allow_ip=&allow_referer=&signature=XO%2F0lnzWDsuhv0U%2BShXim34PFLM%3D)
...
![image](https://blog.kakaocdn.net/dna/bSxvFa/dJMb9QFjqNz/AAAAAAAAAAAAAAAAAAAAAO8wmwUPMUrSgk9i_EQV-vyev_RxxlBfHHXeHYXLj3B6/img.png?credential=yqXZFxpELC7KVnFOS48ylbz2pIh7yKj8&expires=1767193199&allow_ip=&allow_referer=&signature=jU3%2BCaWwomfzlSxrYN%2BWezHjrhM%3D)
