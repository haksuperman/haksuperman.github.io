---
title: "[Multi Cloud] AWS-OCI VPN tunnel 이중화 (BGP)_2.AWS-OCI VPN1 구성(AWS)"       # 글 제목
...
-   OCI 측의 VPN tunnel IP를 Customer Gateway로 생성해야 하지만, 아직 OCI 측 tunnel IP를 모르기 때문에 임시 Customer Gateway를 생성 (1.1.1.1)
...
![image](/assets/img/posts/MultiCloud/MultiCloud02_01.png)

2. Create customer gateway
-  Name tag : \<적절한 이름 입력>
-  BGP ASN : 31898 (OCI 측 ASN은 31898 사용)
-  IP address : \<적절한 임시 IP 입력>
![image](/assets/img/posts/MultiCloud/MultiCloud02_02.png)
...
3. 생성 확인
![image](/assets/img/posts/MultiCloud/MultiCloud02_03.png)
...
![image](/assets/img/posts/MultiCloud/MultiCloud02_04.png)
...
![image](/assets/img/posts/MultiCloud/MultiCloud02_05.png)
...
2. 생성 확인
![image](/assets/img/posts/MultiCloud/MultiCloud02_06.png)

### 2.2.2. VPC Attach
1. VPC → Transit gateway attachments → Create transit gateway attachment
![image](/assets/img/posts/MultiCloud/MultiCloud02_07.png)
...
![image](/assets/img/posts/MultiCloud/MultiCloud02_08.png)

3. 생성 확인
![image](/assets/img/posts/MultiCloud/MultiCloud02_09.png)

## 2.3. Site-to-Site VPN

### 2.3.1. VPN 생성
1. VPC → Virtual private network (VPN) Connections→ Create VPN Connection
![image](/assets/img/posts/MultiCloud/MultiCloud02_10.png)
...
![image](/assets/img/posts/MultiCloud/MultiCloud02_11.png)
...
-   Inside IPv4 CIDR for tunnel 1 : \<OCI 불가 CIDR 제외 하여 입력>
        ...
        {: .prompt-info }
-   Advanced options for tunnel 1 : Phase 1, 2에서 사용할 알고리즘 선택<br> (여기서는 기본 값으로 이용)
![image](/assets/img/posts/MultiCloud/MultiCloud02_12.png)

4. 생성 확인
![image](/assets/img/posts/MultiCloud/MultiCloud02_13.png)

### 2.3.2. Configuration 다운 및 확인

1. 우측 상단 → Download configuration 클릭
![image](/assets/img/posts/MultiCloud/MultiCloud02_14.png)
...
![image](/assets/img/posts/MultiCloud/MultiCloud02_15.png)
