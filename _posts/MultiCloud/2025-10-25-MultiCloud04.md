---
title: "[Multi Cloud] AWS-OCI VPN tunnel 이중화 (BGP)_4.AWS-OCI VPN1 구성(AWS)"       # 글 제목
...
![image](/assets/img/posts/MultiCloud/MultiCloud04_01.png)


2. 생성 확인
![image](/assets/img/posts/MultiCloud/MultiCloud04_02.png)

### 4.1.2. VPN 구성 변경

1. 이전에 생성한 VPN 선택 → 우측 상단 Actions → Modify VPN connection 클릭
![image](/assets/img/posts/MultiCloud/MultiCloud04_03.png)

2. Target customer gateway 변경
![image](/assets/img/posts/MultiCloud/MultiCloud04_04.png)

3. 적용 확인
![image](/assets/img/posts/MultiCloud/MultiCloud04_05.png)

## 4.2. PSK (Pre-Shared Key) 변경

1. 생성한 VPN 우측 상단 → Actions → Modify VPN tunnel options 클릭
![image](/assets/img/posts/MultiCloud/MultiCloud04_06.png)

2. OCI 측과 연결한 tunnel 선택
![image](/assets/img/posts/MultiCloud/MultiCloud04_07.png)

3. OCI 측에서 할당받은 PSK로 변경
![image](/assets/img/posts/MultiCloud/MultiCloud04_08.png)

4. 적용 확인
![image](/assets/img/posts/MultiCloud/MultiCloud04_09.png)
