...
![image](/assets/img/posts/OCI/OCI07_01.png)
...
![image](/assets/img/posts/OCI/OCI07_02.png)


## 3\. 가상 머신 생성
1. \[Compute → Instances\] 선택  
![image](/assets/img/posts/OCI/OCI07_03.png)

2. Create instance 선택  
![image](/assets/img/posts/OCI/OCI07_04.png)

3. Name : oci-demo-app  
Create in Compartment : ociexplained (리소스를 배포하려는 컴파트먼트 선택)  
![image](/assets/img/posts/OCI/OCI07_05.png)
...
![image](/assets/img/posts/OCI/OCI07_06.png)

5. 생성한 퍼블릭 키 업로드  
(하단의 부트 볼륨을 지정하지 않으면 기본값으로 46.6GB 부트 볼륨 크기의 가상 머신이 생성된다)
![image](/assets/img/posts/OCI/OCI07_07.png)

6. Create 선택으로 인스턴스 생성  
![image](/assets/img/posts/OCI/OCI07_08.png)

7. PROVISIONING 상태에서 조금 기다린다.
![image](/assets/img/posts/OCI/OCI07_09.png)

8. RUNNING 상태가 되면 정상 배포가 된 것이다.
![image](/assets/img/posts/OCI/OCI07_10.png)

9. 퍼블릭 IP 할당된 것 확인
![image](/assets/img/posts/OCI/OCI07_11.png)
...
![image](/assets/img/posts/OCI/OCI07_12.png)

2. 생성할 서브넷을 변경해야 한다.
![image](/assets/img/posts/OCI/OCI07_13.png)

3. private subnet-OCI\_DEMO 서브넷으로 변경
![image](/assets/img/posts/OCI/OCI07_14.png)

4. 똑같이 SSH 퍼블릭 키를 업로드
![image](/assets/img/posts/OCI/OCI07_15.png)

5. Create 클릭
![image](/assets/img/posts/OCI/OCI07_16.png)

6. PROVISIOING 상태에서 잠깐 기다린다.
![image](/assets/img/posts/OCI/OCI07_17.png)

7. RUNNING 상태로 바뀌면 정상 배포된 것이다.
![image](/assets/img/posts/OCI/OCI07_18.png)

8. 라이빗 서브넷에 배포했기 때문에 퍼블릭 IP 주소는 할당되지 않았다.
![image](/assets/img/posts/OCI/OCI07_19.png)