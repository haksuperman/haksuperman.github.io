...
tags: [oci, cloud, oraclecloud, oraclecloudinfrastructure, vcn, subnet]     # 태그 (반드시 소문자로 시작 권장)
---
...
![image](https://blog.kakaocdn.net/dna/OPLZ6/btsH3pJdjHi/AAAAAAAAAAAAAAAAAAAAAGZCHI6sq7BzWaYzFdvpF3I7V3pOciabPTmpCWYggUcA/img.png?credential=yqXZFxpELC7KVnFOS48ylbz2pIh7yKj8&expires=1767193199&allow_ip=&allow_referer=&signature=b3OT3qklLS2mqVzY%2Fqa%2FRA03cpc%3D)

2. Start VCN Wizard 선택
![image](https://blog.kakaocdn.net/dna/uFVKt/dJMcafyrfJJ/AAAAAAAAAAAAAAAAAAAAANYs3j3Co3FZlBn4ekcD9sihi7kPTT0fPBjuThfnWR_L/img.png?credential=yqXZFxpELC7KVnFOS48ylbz2pIh7yKj8&expires=1767193199&allow_ip=&allow_referer=&signature=9LLgcjdFH4Nb8FxxCfN91hPZ6dc%3D)

3. VCN Wizard를 시작하면 인터넷만 연결할 것인지, VPN까지 설정할 것인지를 선택할 수 있다.  
Create a VCN with internet connectivity 선택
![image](https://blog.kakaocdn.net/dna/bMmpXB/dJMcagxlmcp/AAAAAAAAAAAAAAAAAAAAALgYks9w9ESYmrBzA2fw8BFYl4pumRioZGEN1VP8VPNG/img.png?credential=yqXZFxpELC7KVnFOS48ylbz2pIh7yKj8&expires=1767193199&allow_ip=&allow_referer=&signature=WDtacI4iXtqNXwWDo6G9uoWPtm8%3D)

4. VCN name : OCI\_DEMO  
Compartment : ociexplained(해당 리소스를 배포하려는 컴파트먼트 선택)
![image](https://blog.kakaocdn.net/dna/tzj52/dJMcabJAufp/AAAAAAAAAAAAAAAAAAAAAHPWWkPnuk_31KMWkoEdyFsMqXm2ydgyt7KYdH2QgmWY/img.png?credential=yqXZFxpELC7KVnFOS48ylbz2pIh7yKj8&expires=1767193199&allow_ip=&allow_referer=&signature=NhnZBEdRA8BW%2FTSKvLmiPBpgKIA%3D)

5. 생성되는 리소스 자원들 확인
![image](https://blog.kakaocdn.net/dna/vBopM/btsH0U5C7sv/AAAAAAAAAAAAAAAAAAAAAC-4OGMXTbdzf7mKYJjYzwRsCUQGKdf-_AtaD-ay3BX6/img.png?credential=yqXZFxpELC7KVnFOS48ylbz2pIh7yKj8&expires=1767193199&allow_ip=&allow_referer=&signature=JKpPDPs0zg1lbyKdJgbBxdbzmvw%3D)
...
6. VCN 생성된 것 확인
![image](https://blog.kakaocdn.net/dna/I5t9s/dJMcafrFQO0/AAAAAAAAAAAAAAAAAAAAABKq_ZY-gFc0UnkrbLlSGoyxJPaErQKvVmbnyoLKJ8Bc/img.png?credential=yqXZFxpELC7KVnFOS48ylbz2pIh7yKj8&expires=1767193199&allow_ip=&allow_referer=&signature=AXQQYxhanJ5GL9k9b3WevZ8n5w8%3D)

7. security\_list\_for\_private\_subnet-OCI\_DEMO 이름으로 시큐리티 리스트 생성됨
![image](https://blog.kakaocdn.net/dna/2uC8x/btsH29GD1jR/AAAAAAAAAAAAAAAAAAAAAH-0zlWxCvASCn1pqGrJa493oxqcmVLNO4bRx35YxmW6/img.png?credential=yqXZFxpELC7KVnFOS48ylbz2pIh7yKj8&expires=1767193199&allow_ip=&allow_referer=&signature=Vac8lAXPNqXOZHNjoTivw2iS%2FQI%3D)

8. 시큐리티 리스트 인그레스에 22번 포트 통신과 ping 명령 수행을 위한 ICMP 통신이 가능하도록 방화벽 규칙도 추가된 상태로 생성된다.
![image](https://blog.kakaocdn.net/dna/s97rU/btsH19gtPXt/AAAAAAAAAAAAAAAAAAAAAN3XxRJI62NiRXAmk9aJFzJN9JfLctuBhVgfh-YpnGbS/img.png?credential=yqXZFxpELC7KVnFOS48ylbz2pIh7yKj8&expires=1767193199&allow_ip=&allow_referer=&signature=xj7Wj8VxuhQF%2FvCMjkIpWbhgfqI%3D)


9. 시큐리티 리스트 이그레스에 모두 허용한 상태로 생성된다.
![image](https://blog.kakaocdn.net/dna/bgGEqg/btsH1MsfXpP/AAAAAAAAAAAAAAAAAAAAABnjODcWR0kNgL5Dc2AnukL6ja1YDqafCQIiUqJ-3dUV/img.png?credential=yqXZFxpELC7KVnFOS48ylbz2pIh7yKj8&expires=1767193199&allow_ip=&allow_referer=&signature=rHB4RYPgwo%2F5jXbq2m0hG%2FEaJao%3D)