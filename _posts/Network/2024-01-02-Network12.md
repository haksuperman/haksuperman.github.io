...
![image](/assets/img/posts/Network/Network12_01.png)
...
![image](/assets/img/posts/Network/Network12_06.png)
...
![image](/assets/img/posts/Network/Network12_07.png)

Laptop에서 192.168.1.1/24의 웹서버 접속 가능(80번 포트를 이용해)

![image](/assets/img/posts/Network/Network12_08.png)

TCP와 HTTP 패킷만 캡처해서 보기 위해 기존의 것을 모두 지우고 TCP와 HTTP만 체크

![image](/assets/img/posts/Network/Network12_09.png)

패킷 캡처해서 확인 가능

![image](/assets/img/posts/Network/Network12_10.png)

출발지 주소, 목적지 주소, 출발지 포트, 목적지 포트 등 헤더 정보 확인 가능

![image](/assets/img/posts/Network/Network12_11.png)
...
![image](/assets/img/posts/Network/Network12_12.png)
![image](/assets/img/posts/Network/Network12_13.png)

4개의 구간에서 ACL을 적용시켜 통신되지 않도록 할 수 있음,

R1의 fa0/0 방향(4번)에 ACL 적용 -> 최종 서버 단과 가장 가까운 라우터의 out 방향(서버쪽 인터페이스)에 설정하는 것이 바람직함

![image](/assets/img/posts/Network/Network12_14.png)

암묵적 거부로 설정되지 않은 ip들도 모두 거부

![image](/assets/img/posts/Network/Network12_15.png)

access-list 100번으로 만든 ACL 그룹을 int fa 0/0 인터페이스에 나가는 방향(out)으로 적용

![image](/assets/img/posts/Network/Network12_16.png)

차단된 매치 패킷 확인 가능

![image](/assets/img/posts/Network/Network12_17.png)

랩탑(192.168.0.1) -> 서버(192.168.0.2)로 핑 안나감

(위에 설정한 deny 정책에 해당은 안되지만, 암묵적 거부로 전체 거부)

![image](/assets/img/posts/Network/Network12_18.png)

ACL 100번에 명시적 허용 추가해줌

(첫번째 거부한 항목을 제외한 나머지 ip 통신은 허용)

![image](/assets/img/posts/Network/Network12_19.png)
...
![image](/assets/img/posts/Network/Network12_20.png)
...
![image](/assets/img/posts/Network/Network12_21.png)
...
![image](/assets/img/posts/Network/Network12_22.png)
...
![image](/assets/img/posts/Network/Network12_23.png)
...
![image](/assets/img/posts/Network/Network12_24.png)
...
![image](/assets/img/posts/Network/Network12_25.png)

192.168.2.0/24 대역에서 192.168.1.1로 핑 차단

![image](/assets/img/posts/Network/Network12_26.png)

192.168.2.0/24 대역에서 192.168.1.1로 웹 패킷 허용

![image](/assets/img/posts/Network/Network12_27.png)

192.168.0.0/24 대역에서 192.168.1.1로 핑 패킷 허용

![image](/assets/img/posts/Network/Network12_28.png)
