...
![image](/assets/img/posts/Network/Network14_01.png)
![image](/assets/img/posts/Network/Network14_02.png)
...
![image](/assets/img/posts/Network/Network14_03.png)
...
![image](/assets/img/posts/Network/Network14_04.png)
...
![image](/assets/img/posts/Network/Network14_05.png)
...
![image](/assets/img/posts/Network/Network14_06.png)
...
![image](/assets/img/posts/Network/Network14_07.png)
...
![image](/assets/img/posts/Network/Network14_08.png)
...
![image](/assets/img/posts/Network/Network14_09.png)
...
![image](/assets/img/posts/Network/Network14_10.png)
...
​
![image](/assets/img/posts/Network/Network14_11.png)
...
![image](/assets/img/posts/Network/Network14_12.png)
...
![image](/assets/img/posts/Network/Network14_13.png)
...
![image](/assets/img/posts/Network/Network14_14.png)
...
![image](/assets/img/posts/Network/Network14_15.png)

![image](/assets/img/posts/Network/Network14_16.png)

![image](/assets/img/posts/Network/Network14_17.png)

![image](/assets/img/posts/Network/Network14_18.png)

---

![image](/assets/img/posts/Network/Network14_19.png)
![image](/assets/img/posts/Network/Network14_20.png)

vlan과 dhcp 설정 후 각 pc들 모두 통신되도록 하기(라우팅 해줘야 함)

![image](/assets/img/posts/Network/Network14_21.png)
...
![image](/assets/img/posts/Network/Network14_22.png)

PC7에서 다른 네트워크로 DHCP Discovery 패킷이 넘어가지 못함

![image](/assets/img/posts/Network/Network14_23.png)

릴레이 넘겨줘야 하는 장비의 인터페이스에 helper-address 설정

ip helper-address 도와줘야 하는 인터페이스의 주소(DHCP 서버의 물리적인 인터페이스 주소)

![image](/assets/img/posts/Network/Network14_24.png)

양쪽에 다 설정했던 dhcp 서버 오른쪽 하나 비활성화

![image](/assets/img/posts/Network/Network14_25.png)

helper 설정 후 왼쪽 DHCP 서버에서 받아오는지 확인(DRA가 제대로 받아오지 못함)

![image](/assets/img/posts/Network/Network14_26.png)

출발지를 지정해서 핑을 때려볼 때 핑은 나감

![image](/assets/img/posts/Network/Network14_27.png)

agent가 Discover 패킷을 정상적으로 보내줌

\-> 서버에서 Offer 패킷을 보내주지 않는 상태, GNS3 문제

![image](/assets/img/posts/Network/Network14_28.png)

수동으로 ip 넣고 핑 확인 -> 가능

![image](/assets/img/posts/Network/Network14_29.png)
