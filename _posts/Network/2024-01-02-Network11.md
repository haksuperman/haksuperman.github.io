...
![image](/assets/img/posts/Network/Network11_01.png)
![image](/assets/img/posts/Network/Network11_02.png)
...
![image](/assets/img/posts/Network/Network11_03.png)
...
![image](/assets/img/posts/Network/Network11_04.png)
...
![image](/assets/img/posts/Network/Network11_05.png)
...
![image](/assets/img/posts/Network/Network11_06.png)

(vmware의 가상 NIC인 VMnet8을 이용해서)

![image](/assets/img/posts/Network/Network11_07.png)
...
![image](/assets/img/posts/Network/Network11_08.png)

\-> 외부 8.8.8.8 대역을 모르니 라우팅 과정이 필요, 디폴트 라우팅으로 싸그리 묶어서 보냄

![image](/assets/img/posts/Network/Network11_09.png)

VMware의 가상 NIC인 GNS3의 NAT 장비(VMnet8)가 변환해줘서 외부망과 연결된 것, 아직 R1에서 NAT 설정은 안함

![image](/assets/img/posts/Network/Network11_10.png)
![image](/assets/img/posts/Network/Network11_11.png)
...
![image](/assets/img/posts/Network/Network11_12.png)

인터페이스 자체에 NAT 설정을 함

![image](/assets/img/posts/Network/Network11_13.png)

허용시킬 acl 생성(내부 사설망이 되는 것)

![image](/assets/img/posts/Network/Network11_14.png)

R1에서 변환시켜준 것이 없다(R1의 NAT 테이블이 올라오지 않음)

![image](/assets/img/posts/Network/Network11_15.png)
...
![image](/assets/img/posts/Network/Network11_16.png)

ip nat pool net108 192.168.108.3 192.168.108.3 netmask 255.255.255.0

공인ip 풀을 만듦

![image](/assets/img/posts/Network/Network11_17.png)

허용시킨 acl 범위의 inside 범위를 nat 변환함(NAT-PAT으로)을 이용해

overload(NAT-PAT으로 하겠다)

![image](/assets/img/posts/Network/Network11_18.png)
...
![image](/assets/img/posts/Network/Network11_19.png)

지금은 공인 ip개 여러 개(192.16.108.3~192.168.108.254)니까 overload 생략(NAT-PAT이 아닌 NAT)

![image](/assets/img/posts/Network/Network11_20.png)
...
![image](/assets/img/posts/Network/Network11_21.png)

---

![image](/assets/img/posts/Network/Network11_22.png)
